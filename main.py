...
#################################################sets######################################################
# sets are a mutal data structure for storing information whose elements do not repeat
#two ways of making sets
set1 = set((1,1,1,2,3,4))
print(set1)

set2 = {1,2,3,4,4,4,4,4,4,4,5}
print(set2)
print(7 in set1)
...
raffle1 = {"Rachel", "Monica", "Phoebe", "Joey", "Chandler", "Ross"}
raffle1.add("Gunther")
print(raffle1)
#################################################booleans######################################################
# booleans
